--Readme document for Eric Chang--
...
5. Is there anything special we need to know in order to run your code?
    ...
    - Hardcoded in activities.html only the shortestActivityType and weekdayOrWeekendLonger ids due to the instructions saying we could do so.
